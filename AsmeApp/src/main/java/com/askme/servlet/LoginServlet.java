...
import com.askme.dao.AdminDAOImpl;
import com.askme.dao.UserDAOImpl;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//doGet(request, response);
		 PrintWriter out=response.getWriter();
			...
			User currentUser = UserDAOImpl.validateUser(email, password);
			 try {
				
				if(currentUser==null)
				{
					User adminuser=AdminDAOImpl.validateAdmin(email, password);					
