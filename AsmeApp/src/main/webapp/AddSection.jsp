<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
     <%@page import="com.askme.impl.CategoryDAOImpl"%>   
 ...
 <form name="section"  action="AddSectionServlet"  method="post">
      ...
      <table>
       <tr>
          ...
          <td><input type="text" name="selectCategoryName" "[A-Za-z]{10, }"required autofocus></td>
        </tr>
        <tr>
          <td><label for="name">Enter Section Name</label></td>
          <td><input type="text" name="sectionName"  "[A-Za-z]{10, }"required autofocus></td>
        </tr>
        <tr>
