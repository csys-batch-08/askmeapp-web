...
create table comment_by_users(comment_id  number generated always as identity(start with 400 increment by 1),
                     user_id number,
                     section_id number,
...
desc comment_by_users;   
select * from comment_by_users;
