       ...
       <c:set var="QuestionList" value="${questionList}"/>
   		...
   		<caption></caption>
			...
			<tbody>
				...
				<td><h3><span class="badge badge-secondary">${QuestionList.questions}</span></h3></td>
				<td><button type="submit"><a href="AnswerServlet?quesId=${QuestionList.questionId }&question=${QuestionList.questions}"> View Answer</a></button>	</td>
				</c:forEach>    				
			</tr>
		           ...
		           <c:otherwise>
		           <h3><span class="badge badge-secondary"><c:out value="No Questions Found"/></span></h3>
		           </c:otherwise>
		       </c:choose>   
