			...
			<table>
				...
				<thead>
					<tr>
						...
						<th id="2"><label id="2"><input type="text" name="question" id="name" id="name"
							pattern="[A-Za-z]+[?]{10, }" required autofocus></label></th>
					</tr>
					<tr>
						<th id="3"><label for="sectionName">Select your
								Section Name</label></th>
						<th id="4"><label id="3"><input type="text" name="sectionName" id="sectionName"
							pattern="[A-Za-z]{10, }" required></label></th>
					</tr>
				</thead>
				<tbody>
					<tr>
