...
.registartion-form input, .registartion-form select, .registartion-form textarea
	{
	border: none;
	padding: 5px;
	margin-top: 10px;
...
.registartion-form input:focus, .registartion-form textarea:focus {
	box-shadow: 3px 3px 10px rgb(228, 228, 228), -3px -3px 10px
		rgb(224, 224, 224);
}
...
<body>
	<div class="container">
		...
		<p style="color: white">
			Already have an account? <a href="login.jsp" style="color: white">Sign
				in</a>
		</p>
	</div>
</body>
