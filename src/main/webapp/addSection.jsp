	...
	<form name="section" action="AddSectionServlet">
		<fieldset id="box">
			...
			<table>
				...
				<thead>
					<tr>
						<th id="1"><label for="name">Select your Category
								Name</label></th>
						<th id="2"><label id="2"><input type="text" name="selectCategoryName" id="name"
							pattern="[A-Za-z]{10, }" required autofocus></label></th>
					</tr>
					<tr>
						<th id="3"><label for="name">Enter Section Name</label></th>
						<th id="4"><label id="3"><input type="text" name="sectionName" id="name"
							pattern="[A-Za-z]{10, }" required autofocus></label></th>
					</tr>
					<tr>
						<th id="5"><label for="picture">Image</label></th>
						<th id="6"><label id="4"><input type="file" name="picture" id="picture"></label></th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td colspan="2"><label id="5"><input type="submit" class="submit" id="5"/></label></td>
					</tr>
				</tbody>
			</table>
		</fieldset>
