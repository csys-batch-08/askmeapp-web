...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" >Section <span class="caret"></span></a>
        <ul class="dropdown-menu">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" >Question <span class="caret"></span></a>
        <ul class="dropdown-menu">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" >Answer <span class="caret"></span></a>
        <ul class="dropdown-menu">
    ...
    <legend> Delete Category</legend> 
      ...
      <thead>
        <tr>
          ...
          <th id="2"><input type="text" name="CategoryName1" pattern="[A-Za-z]{10, }" required autofocus></th>
        </tr>
        </thead>
        <tbody>
        <tr>
