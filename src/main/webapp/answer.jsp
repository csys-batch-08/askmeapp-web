...
<div id="toolbar"></div>
	...
	<c:choose>
					...
					<tbody>
						<tr>
							<c:forEach var="AnswerList" items="${answerList}">
								<td><h3><span class="badge badge-secondary">${AnswerList.answers}</span></h3></td>
								<td colspan="2"><button type="submit"> Okay</button></td>
							</c:forEach>
		...
		<c:otherwise>
		<h3><span class="badge badge-secondary"><c:out value="No Answers Found" /></span></h3>
		</c:otherwise>
	</c:choose>
