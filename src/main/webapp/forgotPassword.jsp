...
.forgotpassword input, .forgotpassword select, .forgotpassword textarea
	{
	border: none;
	padding: 5px;
	margin-top: 10px;
...
.forgotpassword input:focus, .forgotpassword textarea:focus {
...
.forgotpassword .submit:hover {
	...
	<div class="container">
		...
		<form name="forgotPassword" class="forgotpassword"
			action="ForgotPasswordServlet" method="post">
			<table>
				<caption></caption>
				<thead>
					<tr>
